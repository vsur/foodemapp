...
class ParticipantsCodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'vizvar' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2023-01-13 14:58:22',
                'modified' => '2023-01-13 14:58:22',
            ],
        ];
        parent::init();
    }
