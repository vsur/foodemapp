    ...
    <div class="col-md-12">
        ...
        <ul id="mapComponentsChoice" class="nav nav-pills">
            <?php if ( isset($configuredSelection) ) : ?>
                <li role="presentation" class="active"><a href="#" id="mapComponentsChosen" data-component-presentation="chosen">Gesuchte Kategorien</a></li>
            <?php endif;?>
            ...
            <li role="presentation" class="<?= isset($configuredSelection) ? '': 'active' ?>"><a href="#" id="mapComponentsHide" data-component-presentation="none">Kategorien ausblenden</a></li>
            <li role="presentation"><a href="#" id="mapComponentsOther" data-component-presentation="other">Übrige Kategorien</a></li>
