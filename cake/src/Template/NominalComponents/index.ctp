...
<div class="nominalComponents index large-9 medium-8 columns content">
    <h3><?= __('Nominal Components') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($nominalComponents as $nominalComponent): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $nominalComponent->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $nominalComponent->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $nominalComponent->id], ['confirm' => __('Are you sure you want to delete # {0}?', $nominalComponent->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
