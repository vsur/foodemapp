...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Binary Component'), ['action' => 'edit', $binaryComponent->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Binary Component'), ['action' => 'delete', $binaryComponent->id], ['confirm' => __('Are you sure you want to delete # {0}?', $binaryComponent->id)]) ?> </li>
...
<div class="binaryComponents view large-9 medium-8 columns content">
    <h3><?= h($binaryComponent->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($binaryComponent->ypois)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($binaryComponent->ypois as $ypois): ?>
            <tr>
                <td><?= h($ypois->id) ?></td>
